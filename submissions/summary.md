...
| Quản lý thành viên, Tra cứu | 5 | 1 (BUG-003 — 3 biểu hiện, cùng 1 root cause) | 🔴 Kém | BUG-003: Logic email validation bị lỗi — từ chối email hợp lệ (TC-21), chấp nhận email không hợp lệ (TC-22), và báo sai lỗi cho email trùng (TC-23). |
