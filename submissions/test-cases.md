...
| TC-03 | Đăng nhập thành công với tài khoản bị Tạm ngưng/Hết hạn | Mở trang chủ hệ thống | 1. Nhập email của tài khoản Tạm ngưng. 2. Nhập mật khẩu đúng. 3. Nhấn nút "Đăng nhập". | Email: `cu.le@email.com` Mật khẩu: `password123` | Chuyển sang trang chủ. Trên AppBar hiển thị tên "Lê Cần Cù" và vai trò "Thành viên". Không có thông báo lỗi đăng nhập. | REQ-01 | EP |
...
| **Mã TC** | **Mục tiêu kiểm thử** | **Tiền điều kiện** | **Bước thực hiện** | **Dữ liệu đầu vào** | **Kết quả mong đợi** | **REQ** | **Kỹ thuật** |
| --- | --- | --- | --- | --- | --- | --- | --- |
| TC-71 | Thêm thành viên mới thành công | Đăng nhập bằng tài khoản Thủ thư, ở tab Thành viên | 1. Nhấn Thêm thành viên. 2. Nhập thông tin hợp lệ. 3. Nhấn Lưu. | Tên: `Nguyễn Văn A` Email: `nva@test.com` SĐT: `0987654321` | Thông báo thành công. Thành viên mới xuất hiện trong danh sách. | REQ-07 | EP |
| TC-72 | Phân quyền truy cập chức năng Thêm thành viên, xem thành viên | Đăng nhập bằng tài khoản Thành viên (`ba.nguyen@email.com`) | 1. Quan sát thanh điều hướng (AppBar) và giao diện màn hình. | Không | Không có tab "Thành viên" hoặc nút "Thêm thành viên" trên màn hình. | REQ-07 | EP |
| TC-73 | Thêm thành viên thất bại (Email thiếu `@`) | Đăng nhập Thủ thư, mở form Thêm TV | 1. Nhập thông tin với Email sai (thiếu `@`). 2. Thêm thành viên. | Email: `nvatest.com` | Báo lỗi email không hợp lệ. | REQ-07 | EP |
| TC-74 | Thêm thành viên thất bại (Trùng Email) | Đăng nhập Thủ thư, mở form Thêm TV | 1. Nhập Email đã có trong dữ liệu (Seed data). 2. Thêm thành viên. | Email: `ba.nguyen@email.com` | Báo lỗi email đã tồn tại. Không tạo mới. | REQ-07 | EP |
| TC-75 | Thêm thành viên thất bại (SĐT không bắt đầu bằng `0`) | Đăng nhập Thủ thư, mở form Thêm TV | 1. Nhập SĐT không bắt đầu bằng số 0. 2. Thêm thành viên. | SĐT: `8987654321` | Báo lỗi SĐT không hợp lệ. | REQ-07 | EP |
| TC-76 | Thêm thành viên thất bại (SĐT thiếu độ dài) | Đăng nhập Thủ thư, mở form Thêm TV | 1. Nhập SĐT có 9 chữ số. 2. Thêm thành viên. | SĐT: `098765432` | Báo lỗi SĐT không hợp lệ (phải đủ 10 số). | REQ-07 | BVA |
| TC-77 | Thêm thành viên thất bại (Bỏ trống thông tin) | Đăng nhập Thủ thư, mở form Thêm TV | 1. Bỏ trống các trường bắt buộc. 2. Thêm thành viên. | Tất cả: `""` | Báo lỗi yêu cầu điền đầy đủ thông tin. | REQ-07 | EP |
