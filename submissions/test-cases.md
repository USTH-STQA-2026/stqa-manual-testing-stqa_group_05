...
| TC-15 | Search books is case-insensitive | Logged in | 1. Enter keyword in lowercase/UPPERCASE | Keyword: `flutter` OR `FLUTTER` | Displays book(s) containing keyword in its title, either in lowercase or UPPERCASE (same as TC-12). | REQ-03 | EP |
