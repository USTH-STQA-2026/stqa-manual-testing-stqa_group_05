...
| TC-06 | Displays message: "Please enter email" | Displays message "Please enter email and password" | Fail | [BUG-01.1](bug-evidence/bug01-1.png) | BUG-01 |
| TC-07 | Displays message: "Please enter password" | Displays message: "Please enter email and password" | Fail | [BUG-01.2](bug-evidence/bug01-2.png)| BUG-01 |
...
| TC-21 | Borrow rejected, displays distinct error message for **suspended account** | Borrow rejected<br>Display warning `Expired member. Cannot borrow books!` | Fail | [BUG-02](bug-evidence/bug02.png) | BUG-02 |
...
| TC-25 | Book returned successfully but with an overdue warning notification | Book returned successfully, status reverts to "Available", displays return date but **no overdue warning displayed** | Fail | [BUG-04.1](bug-evidence/bug04-1.png) | BUG-04 |
| TC-26 | Book returned successfully but with an overdue warning notification | Book returned successfully, status reverts to "Available", displays return date but **no overdue warning displayed** | Fail | [BUG-04.2](bug-evidence/bug04-2.png) | BUG-04 |
| TC-27 | System rejects the return action; borrow record remains in "Borrowed" status | System displays "Book returned successfully", book's status returned to "Available" | Fail | [BUG-05](bug-evidence/bug05.png) | BUG-05 |
...
| TC-31 | New member added successfully, member code is generated and displayed | Add member failed and system displayed "Invalid email" | Fail | [BUG-06](bug-evidence/bug06.png) | BUG-06 |
| TC-32 | System rejects creation, displays email format error message | System displays "Member added successfully! ID: MEM007" | Fail | [BUG-07.1](bug-evidence/bug07-1.png)<br>[BUG-07.2](bug-evidence/bug07-2.png)<br>[BUG-07.3](bug-evidence/bug07-3.png) | BUG-07 |
| TC-33 | System rejects creation, displays duplicate email error message | Add member failed and system displayed "Invalid email" | Fail | [BUG-08](bug-evidence/bug08.png) | BUG-08 |
...
| TC-35 | System rejects action, displays "Phone number must not be blank" | Add member failed and system displayed "Invalid email" | Fail | [BUG-09](bug-evidence/bug09.png) | BUG-09 |
| TC-36 | System rejects action, displays "Invalid Phone number" | Add member failed and system displayed "Invalid email" | Fail | [BUG-10](bug-evidence/bug10.png) | BUG-10 |
...
| TC-39 | System rejects lookup or does not display `MEM006`'s records | After logging in as `MEM002`, searching with Member ID `MEM006` still displays MEM006’s borrow records | Fail | [BUG-11.1](bug-evidence/bug11-1.png)<br>[BUG-11.2](bug-evidence/bug11-2.png) | BUG-11 |
